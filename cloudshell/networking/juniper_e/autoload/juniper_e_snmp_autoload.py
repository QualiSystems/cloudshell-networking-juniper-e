...
import re
import os
from cloudshell.networking.juniper_e.autoload.snmp_entity_table import CiscoSNMPEntityTable
from cloudshell.networking.juniper_e.autoload.snmp_if_table import SnmpIfTable
...
class JuniperESNMPAutoload(object):
    IF_ENTITY = "ifDescr"
